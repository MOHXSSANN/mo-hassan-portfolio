export const siteConfig = {
  ...
  currentFocus: "Building secure document management systems at CBSA and exploring AI-powered search",
  ...
  about: {
    ...
    highlights: [
      "Building secure government-grade systems at CBSA",
      "Passionate about cybersecurity and backend architecture",
      "Strong focus on performance — sub-50ms query optimization",
      "Three-time Henry Marshall Tory Scholar at Carleton",
    ],
  },
  ...
  achievements: [
    {
      title: "Three-time Henry Marshall Tory Scholarship",
